...
// #include "brain_bit_alt_input_full.h"
...
void print_brain_bit_alt_config(esp_thread_info_t *x)
{
    printf("\n====== %s ====== config registers: \n", x->devname);
    printf("  .avg          = %d\n", ((struct brain_bit_alt_vivado_access *)x->esp_desc)->avg);
    printf("  .key_length   = %d\n", ((struct brain_bit_alt_vivado_access *)x->esp_desc)->key_length);
    printf("  .std          = %d\n", ((struct brain_bit_alt_vivado_access *)x->esp_desc)->std);
    printf("  .R            = %d\n", ((struct brain_bit_alt_vivado_access *)x->esp_desc)->R);
    printf("  .d            = %d\n", ((struct brain_bit_alt_vivado_access *)x->esp_desc)->d);
    printf("  .h            = %d\n", ((struct brain_bit_alt_vivado_access *)x->esp_desc)->h);
    printf("  .key_batch    = %d\n", ((struct brain_bit_alt_vivado_access *)x->esp_desc)->key_batch);
    printf("  .key_num      = %d\n", ((struct brain_bit_alt_vivado_access *)x->esp_desc)->key_num);
    printf("  .val_num      = %d\n", ((struct brain_bit_alt_vivado_access *)x->esp_desc)->val_num);
    printf("  .tot_iter 	= %d\n", ((struct brain_bit_alt_vivado_access *)x->esp_desc)->tot_iter);
}
...
void init_parameters_brain_bit_alt(void)
{
...
void init_buffer_brain_bit_alt(token_t *in, token_t *gold)
{
    int i;
    int j;
    int k;
...
int validate_buffer_brain_bit_alt(token_t *out, token_t *gold)
{
    int i;
    int j;
    unsigned errors = 0;
...
void set_aes_in_from_brain_bit_alt_out(token_t *in_aes, token_t *out_brain)
{
...
int run_brain_bit_alt_only(void)
{
    printf("==================================================\n");
    printf("==   Start ** brain_bit_alt **                      ==\n");
    printf("==================================================\n");
    ...
    init_parameters_brain_bit_alt();

    buf = (token_t *)esp_alloc(brain_size);
    cfg_brain_bit_alt_000[0].hw_buf = buf;
    memset(buf, 0, brain_size);

    gold = malloc(brain_out_size);

    init_buffer_brain_bit_alt(buf, gold);

    printf("\n====== %s ====== config registers: \n", cfg_brain_bit_alt_000[0].devname);
    printf("  .avg          = %f\n", avg);
    printf("  .key_length   = %d\n", key_length);
    printf("  .std          = %f\n", std);
    printf("  .R            = %f\n", R);
    ...
    ((struct brain_bit_alt_vivado_access *)cfg_brain_bit_alt_000[0].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_brain_bit_alt_000[0].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_brain_bit_alt_000[0].esp_desc)->R = R_u;

    // printf("Value avg: %x\n", ((struct brain_bit_alt_vivado_access*) cfg_brain_bit_alt_000[0].esp_desc)->avg);
    // printf("Value std: %x\n", ((struct brain_bit_alt_vivado_access*) cfg_brain_bit_alt_000[0].esp_desc)->std);
    // printf("Value R: %x\n", ((struct brain_bit_alt_vivado_access*) cfg_brain_bit_alt_000[0].esp_desc)->R);
    ...
    printf("\n  ** acc START **\n");
    esp_run(cfg_brain_bit_alt_000, NACC);
    printf("\n  ** acc DONE **\n");

    errors = validate_buffer_brain_bit_alt(&buf[brain_out_offset], gold);
...
{
    printf("==================================================\n");
    printf("==   Start ** brain_bit_alt + aes (mem_1x1) **      ==\n");
    printf("==================================================\n");
    ...
    // set brain_bit_alt config registers
    //key_length = 128;
    key_batch = N*1.1;
    key_num = N;
    val_num = 0;
    ...
    buf_brain = (token_t *)esp_alloc(brain_size+aes_size_bytes);
    /* buf_aes = (token_t *)esp_alloc(aes_size_bytes); */
    cfg_brain_bit_alt_000[0].hw_buf = buf_brain;
    memset(buf_brain, 0, brain_size+aes_size_bytes);
    /* gold_brain = malloc(brain_out_size); */

    /* init_buffer_brain_bit_alt(buf_brain, gold_brain); */
    ...
    ((struct brain_bit_alt_vivado_access *)cfg_brain_bit_alt_000[0].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_brain_bit_alt_000[0].esp_desc)->key_batch = key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_brain_bit_alt_000[0].esp_desc)->key_num = N;
    ((struct brain_bit_alt_vivado_access *)cfg_brain_bit_alt_000[0].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_brain_bit_alt_000[0].esp_desc)->tot_iter = tot_iter;

    token_t* brain_out_location = &buf_brain[brain_out_offset];
    /* buf_aes = brain_out_location; */

    print_brain_bit_alt_config(&cfg_brain_bit_alt_000[0]);
    ...
    /* printf("\n  ** START **\n"); */
    /* // Run brain_bit_alt in isolation */
    /* for (i = 0; i < N; i++) */
    /* { */
    /*     esp_run(cfg_brain_bit_alt_000, NACC); */
    /*     total_time += cfg_brain_bit_alt_000[0].hw_ns; */
    /* } */
    /* printf("\n  ** DONE **\n"); */
    ...
    /* set_aes_in_from_brain_bit_alt_out(buf_aes, &buf_brain[brain_out_offset]); */
    ...
    /* { */
    gettime(&th_start);
    esp_run_no_print(cfg_brain_bit_alt_000, 1);
    gettime(&th_end);

    brain_time = ts_subtract(&th_start, &th_end);

    gettime(&th_start);
    set_aes_in_from_brain_bit_alt_out(buf_aes, brain_out_location);
    gettime(&th_end);
    ...
    total_time = cfg_aes_000[0].hw_ns + cfg_brain_bit_alt_000[0].hw_ns;
    ...
    /* printf("brain_time: %llu, mem time: %llu, aes time: %llu, total: %llu\n", brain_time, mem_time, aes_time, brain_time+mem_time+aes_time); */
    printf("==================================================\n");
    printf("==   Finish ** brain_bit_alt + aes (mem_1x1) **     ==\n");
    printf("==     N: %d\tTotal time: %llu\n", N, total_time);
    printf("==================================================\n");

    fprintf(log_file, "-- mem_1x1 brain_bit_alt time: %llu\n", cfg_brain_bit_alt_000[0].hw_ns);
...
{
    printf("==================================================\n");
    printf("==   Start ** brain_bit_alt + aes (p2p_1x1) **      ==\n");
    printf("==================================================\n");
    ...
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_1x1[0].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_1x1[0].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_1x1[0].esp_desc)->R = R_u;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_1x1[0].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_1x1[0].esp_desc)->key_batch = key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_1x1[0].esp_desc)->key_num = key_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_1x1[0].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_1x1[0].esp_desc)->tot_iter = tot_iter;
    ...
    print_brain_bit_alt_config(&cfg_p2p_1x1[0]);
    ...
    printf("==================================================\n");
    printf("==   Finish ** brain_bit_alt + aes (p2p_1x1) **     ==\n");
    printf("==     N: %d\tTotal time: %llu\n", N, total_time);
    printf("==================================================\n");
...
{
    printf("==================================================\n");
    printf("==   Start ** brain_bit_alt + aes (p2p_1x2) **      ==\n");
    printf("==================================================\n");
    ...
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_1x2[0].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_1x2[0].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_1x2[0].esp_desc)->R = R_u;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_1x2[0].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_1x2[0].esp_desc)->key_batch = key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_1x2[0].esp_desc)->key_num = key_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_1x2[0].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_1x2[0].esp_desc)->tot_iter = tot_iter;
    ...
    print_brain_bit_alt_config(&cfg_p2p_1x2[0]);
    ...
    printf("==================================================\n");
    printf("==   Finish ** brain_bit_alt + aes (p2p_1x2) **     ==\n");
    printf("==================================================\n");
...
{
    printf("==================================================\n");
    printf("==   Start ** brain_bit_alt + aes (p2p_2x1) **      ==\n");
    printf("==================================================\n");
    ...
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x1[0].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x1[0].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x1[0].esp_desc)->R = R_u;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x1[0].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x1[0].esp_desc)->key_batch = key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x1[0].esp_desc)->key_num = key_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x1[0].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x1[0].esp_desc)->tot_iter = tot_iter;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x1[1].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x1[1].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x1[1].esp_desc)->R = R_u;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x1[1].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x1[1].esp_desc)->key_batch = key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x1[1].esp_desc)->key_num = key_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x1[1].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x1[1].esp_desc)->tot_iter = tot_iter;
    ...
    print_brain_bit_alt_config(&cfg_p2p_1x1[0]);
    print_brain_bit_alt_config(&cfg_p2p_1x1[1]);
    ...
    printf("==================================================\n");
    printf("==   Finish ** brain_bit_alt + aes (p2p_2x1) **     ==\n");
    printf("==     N: %d\tTotal time: %llu\n", N, total_time);
    printf("==================================================\n");
...
{
    printf("==================================================\n");
    printf("==   Start ** brain_bit_alt + aes (p2p_3x1) **      ==\n");
    printf("==================================================\n");
    ...
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[0].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[0].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[0].esp_desc)->R = R_u;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[0].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[0].esp_desc)->key_batch = key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[0].esp_desc)->key_num = key_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[0].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[0].esp_desc)->tot_iter = tot_iter;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[1].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[1].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[1].esp_desc)->R = R_u;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[1].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[1].esp_desc)->key_batch = key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[1].esp_desc)->key_num = key_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[1].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[1].esp_desc)->tot_iter = tot_iter;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[2].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[2].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[2].esp_desc)->R = R_u;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[2].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[2].esp_desc)->key_batch = key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[2].esp_desc)->key_num = key_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[2].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x1[2].esp_desc)->tot_iter = tot_iter;
    ...
    print_brain_bit_alt_config(&cfg_p2p_3x1[0]);
    print_brain_bit_alt_config(&cfg_p2p_3x1[1]);
    print_brain_bit_alt_config(&cfg_p2p_3x1[2]);
    ...
    printf("==================================================\n");
    printf("==   Finish ** brain_bit_alt + aes (p2p_3x1) **     ==\n");
    printf("==     N: %d\tTotal time: %llu\n", N, total_time);
    printf("==================================================\n");
...
{
    printf("==================================================\n");
    printf("==   Start ** brain_bit_alt + aes (p2p_4x1) **      ==\n");
    printf("==================================================\n");
    ...
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[0].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[0].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[0].esp_desc)->R = R_u;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[0].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[0].esp_desc)->key_batch = key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[0].esp_desc)->key_num = key_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[0].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[0].esp_desc)->tot_iter = tot_iter;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[1].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[1].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[1].esp_desc)->R = R_u;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[1].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[1].esp_desc)->key_batch = key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[1].esp_desc)->key_num = key_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[1].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[1].esp_desc)->tot_iter = tot_iter;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[2].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[2].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[2].esp_desc)->R = R_u;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[2].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[2].esp_desc)->key_batch = key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[2].esp_desc)->key_num = key_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[2].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[2].esp_desc)->tot_iter = tot_iter;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[3].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[3].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[3].esp_desc)->R = R_u;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[3].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[3].esp_desc)->key_batch = key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[3].esp_desc)->key_num = key_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[3].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x1[3].esp_desc)->tot_iter = tot_iter;
    ...
    print_brain_bit_alt_config(&cfg_p2p_4x1[0]);
    print_brain_bit_alt_config(&cfg_p2p_4x1[1]);
    print_brain_bit_alt_config(&cfg_p2p_4x1[2]);
    print_brain_bit_alt_config(&cfg_p2p_4x1[3]);
    ...
    printf("==================================================\n");
    printf("==   Finish ** brain_bit_alt + aes (p2p_4x1) **     ==\n");
    printf("==     N: %d\tTotal time: %llu\n", N, total_time);
    printf("==================================================\n");
...
{
    printf("==================================================\n");
    printf("==   Start ** brain_bit_alt + aes (p2p_4x4) **      ==\n");
    printf("==================================================\n");
    ...
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[0].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[0].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[0].esp_desc)->R = R_u;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[0].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[0].esp_desc)->key_batch = key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[0].esp_desc)->key_num = key_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[0].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[0].esp_desc)->tot_iter = tot_iter;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[1].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[1].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[1].esp_desc)->R = R_u;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[1].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[1].esp_desc)->key_batch = key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[1].esp_desc)->key_num = key_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[1].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[1].esp_desc)->tot_iter = tot_iter;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[2].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[2].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[2].esp_desc)->R = R_u;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[2].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[2].esp_desc)->key_batch = key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[2].esp_desc)->key_num = key_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[2].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[2].esp_desc)->tot_iter = tot_iter;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[3].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[3].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[3].esp_desc)->R = R_u;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[3].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[3].esp_desc)->key_batch = key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[3].esp_desc)->key_num = key_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[3].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_4x4[3].esp_desc)->tot_iter = tot_iter;
    ...
    print_brain_bit_alt_config(&cfg_p2p_4x4[0]);
    print_brain_bit_alt_config(&cfg_p2p_4x4[1]);
    print_brain_bit_alt_config(&cfg_p2p_4x4[2]);
    print_brain_bit_alt_config(&cfg_p2p_4x4[3]);
    ...
    printf("==================================================\n");
    printf("==   Finish ** brain_bit_alt + aes (p2p_4x4) **     ==\n");
    printf("==     N: %d\tTotal time: %llu\n", N, total_time);
    printf("==================================================\n");
...
{
    printf("==================================================\n");
    printf("==   Start ** brain_bit_alt + aes (p2p_2x3) **      ==\n");
    printf("==================================================\n");
    ...
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x3[0].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x3[0].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x3[0].esp_desc)->R = R_u;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x3[0].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x3[0].esp_desc)->key_batch = key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x3[0].esp_desc)->key_num = key_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x3[0].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x3[0].esp_desc)->tot_iter = tot_iter;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x3[1].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x3[1].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x3[1].esp_desc)->R = R_u;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x3[1].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x3[1].esp_desc)->key_batch = 2 * key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x3[1].esp_desc)->key_num = 2 * key_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x3[1].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_2x3[1].esp_desc)->tot_iter = tot_iter;
    ...
    print_brain_bit_alt_config(&cfg_p2p_2x3[0]);
    print_brain_bit_alt_config(&cfg_p2p_2x3[1]);
    ...
    printf("==================================================\n");
    printf("==   Finish ** brain_bit_alt + aes (p2p_2x3) **     ==\n");
    printf("==     N: %d\tTotal time: %llu\n", N, total_time);
    printf("==================================================\n");
...
{
    printf("==================================================\n");
    printf("==   Start ** brain_bit_alt + aes (p2p_3x2) **      ==\n");
    printf("==================================================\n");
    ...
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[0].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[0].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[0].esp_desc)->R = R_u;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[0].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[0].esp_desc)->key_batch = key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[0].esp_desc)->key_num = key_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[0].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[0].esp_desc)->tot_iter = tot_iter;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[1].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[1].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[1].esp_desc)->R = R_u;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[1].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[1].esp_desc)->key_batch = key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[1].esp_desc)->key_num = key_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[1].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[1].esp_desc)->tot_iter = tot_iter;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[2].esp_desc)->avg = avg_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[2].esp_desc)->std = std_u;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[2].esp_desc)->R = R_u;

    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[2].esp_desc)->key_length = key_length;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[2].esp_desc)->key_batch = key_batch;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[2].esp_desc)->key_num = key_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[2].esp_desc)->val_num = val_num;
    ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[2].esp_desc)->tot_iter = tot_iter;
    ...
    printf("  .avg          = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[0].esp_desc)->avg);
    printf("  .key_length   = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[0].esp_desc)->key_length);
    printf("  .std          = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[0].esp_desc)->std);
    printf("  .R            = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[0].esp_desc)->R);
    printf("  .d            = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[0].esp_desc)->d);
    printf("  .h            = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[0].esp_desc)->h);
    printf("  .key_batch    = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[0].esp_desc)->key_batch);
    printf("  .key_num      = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[0].esp_desc)->key_num);
    printf("  .val_num      = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[0].esp_desc)->val_num);
    printf("  .tot_iter 	= %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[0].esp_desc)->tot_iter);

    printf("\n====== %s ====== config registers: \n", cfg_p2p_3x2[1].devname);
    printf("  .avg          = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[1].esp_desc)->avg);
    printf("  .key_length   = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[1].esp_desc)->key_length);
    printf("  .std          = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[1].esp_desc)->std);
    printf("  .R            = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[1].esp_desc)->R);
    printf("  .d            = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[1].esp_desc)->d);
    printf("  .h            = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[1].esp_desc)->h);
    printf("  .key_batch    = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[1].esp_desc)->key_batch);
    printf("  .key_num      = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[1].esp_desc)->key_num);
    printf("  .val_num      = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[1].esp_desc)->val_num);
    printf("  .tot_iter 	= %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[1].esp_desc)->tot_iter);

    printf("\n====== %s ====== config registers: \n", cfg_p2p_3x2[2].devname);
    printf("  .avg          = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[2].esp_desc)->avg);
    printf("  .key_length   = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[2].esp_desc)->key_length);
    printf("  .std          = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[2].esp_desc)->std);
    printf("  .R            = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[2].esp_desc)->R);
    printf("  .d            = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[2].esp_desc)->d);
    printf("  .h            = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[2].esp_desc)->h);
    printf("  .key_batch    = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[2].esp_desc)->key_batch);
    printf("  .key_num      = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[2].esp_desc)->key_num);
    printf("  .val_num      = %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[2].esp_desc)->val_num);
    printf("  .tot_iter 	= %d\n", ((struct brain_bit_alt_vivado_access *)cfg_p2p_3x2[2].esp_desc)->tot_iter);
    ...
    printf("==================================================\n");
    printf("==   Finish ** brain_bit_alt + aes (p2p_3x2) **     ==\n");
    printf("==     N: %d\tTotal time: %llu\n", N, total_time);
    printf("==================================================\n");
...
int main(int argc, char **argv)
{
    ...
    // errors_0 = run_brain_bit_alt_only();
