...
// struct brain_bit_alt_alt_vivado_access {
// 	struct esp_access esp;
// 	/* <<--regs-->> */
// 	unsigned avg;
// 	unsigned key_length;
...
// #define BRAIN_BIT_ALT_ALT_VIVADO_IOC_ACCESS	_IOW ('S', 0, struct brain_bit_alt_alt_vivado_access)
...
const int32_t H = H_val;
const int32_t D = D_val;
int32_t h = H_val;
int32_t d = D_val;
