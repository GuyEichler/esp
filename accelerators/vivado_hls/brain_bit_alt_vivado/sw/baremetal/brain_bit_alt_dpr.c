...
int main(int argc, char * argv[])
{
	...
	for (n = 0; n < ndev; n++) {
...
#else
		{
			...
			unsigned long int cycles_diff_l_prev;

			unsigned long long total_time = 0;
			unsigned N_runs = 10;

			unsigned max_dpr_threshold = 1.1;
			unsigned min_dpr_threshold = 0.8;
