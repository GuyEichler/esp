...
struct kalman_lite_fx_vivado_access kalman_lite_fx_cfg_000[] = {
	{
		/* <<--descriptor-->> */
		.inv_reset = INV_RESET,
		.inv_num = INV_NUM,
...
esp_thread_info_t cfg_000[] = {
	{
		.run = true,
		.devname = "kalman_lite_fx_vivado.0",
		.ioctl_req = KALMAN_LITE_FX_VIVADO_IOC_ACCESS,
		.esp_desc = &(kalman_lite_fx_cfg_000[0].esp),
	}
};
