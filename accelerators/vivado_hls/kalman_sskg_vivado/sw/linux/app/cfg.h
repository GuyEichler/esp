...
struct kalman_sskg_vivado_access kalman_sskg_cfg_000[] = {
	{
		/* <<--descriptor-->> */
		.inv_reset = INV_RESET,
		.inv_num = INV_NUM,
...
esp_thread_info_t cfg_000[] = {
	{
		.run = true,
		.devname = "kalman_sskg_vivado.0",
		.ioctl_req = KALMAN_SSKG_VIVADO_IOC_ACCESS,
		.esp_desc = &(kalman_sskg_cfg_000[0].esp),
	}
};
