...
#set_directive_pipeline -II 1 "compute/LOOP_TERM3"
#set_directive_pipeline -II 1 "compute/LOOP_TERM4"
#set_directive_unroll -factor 4 "compute/LOOP_TERM4"
#set_directive_unroll "compute/LOOP_TERM4"
#set_directive_array_partition -type cyclic -factor 4 -dim 2 "compute" final_term
#set_directive_dependence -variable final_term -type inter -dependent false "compute/LOOP_TERM4"
set_directive_pipeline -II 1 "compute/LOOP_INIT_FIN2"
...
# set_directive_array_partition -type cyclic -factor 4 -dim 2 "compute" Sw
